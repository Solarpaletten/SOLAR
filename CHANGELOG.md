...
- `docs:` рекомендация использовать `zsh` для локальной разработки и информация о различиях с `bash` в CI
- `docs:` расширенная документация по работе с тестовой инфраструктурой в README.md
