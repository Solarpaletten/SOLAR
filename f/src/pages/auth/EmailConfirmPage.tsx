  ...
  useEffect(() => {
    const confirmEmail = async () => {
      ...
      try {
        ...
        setError(err.message || t('Failed to confirm your email. Please try again.'));
      } finally {
        setIsLoading(false);
      }
    };
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
      ...
      <div className="flex-grow flex items-center justify-center">
        <div className="max-w-md w-full p-6 bg-white rounded shadow">
          <h1 className="text-2xl font-bold mb-4 text-center">{t('Email Confirmation')}</h1>
          
          {isLoading && (
            <div className="text-center my-8">
              <div className="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-gray-900"></div>
              <p className="mt-2 text-gray-600">{t('Verifying your email...')}</p>
            </div>
          )}
          ...
          {success && (
            <div className="bg-green-50 border border-green-200 rounded-md p-4 my-4">
              <div className="flex items-center">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-green-800">{t('Email confirmed successfully!')}</h3>
          ...
          {error && (
            <div className="bg-red-50 border border-red-200 rounded-md p-4 my-4">
              <div className="flex">
                ...
                <div className="ml-3">
                  <h3 className="text-sm font-medium text-red-800">{t('Email confirmation failed')}</h3>
