...
const OnboardingSchema = Yup.object().shape({
  companyCode: Yup.string()
    ...
    .matches(/^[a-zA-Z0-9_-]+$/, 'Company code can only contain letters, numbers, dash and underscore'),
          ...
          <Form className="space-y-4">
            <div>
              ...
              <Field
                ...
                className={`mt-1 block w-full border rounded px-3 py-2 text-sm ${
                  errors.companyCode && touched.companyCode ? 'border-red-500' : 'border-gray-300'
                }`}
              />
              <ErrorMessage name="companyCode" component="p" className="mt-1 text-sm text-red-600" />
            </div>
            ...
            <div>
              ...
              <Field
                ...
                name="directorName"
                className={`mt-1 block w-full border rounded px-3 py-2 text-sm ${
                  errors.directorName && touched.directorName ? 'border-red-500' : 'border-gray-300'
                }`}
              />
              <ErrorMessage name="directorName" component="p" className="mt-1 text-sm text-red-600" />
            </div>
